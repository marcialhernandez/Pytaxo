...
class xmlEntrada:
    ...
    def __init__(self,nombre,tipo,puntaje,alternativas,cantidadAlternativas,shuffleanswers,penalty,answernumbering,link,**kwargs):
        ...
        elif self.tipo=="condicionalesPython":
            self.codigos=kwargs['codigos']
            self.comentarios=kwargs['comentarios']
            self.terminoAPreguntar=kwargs['terminoAPreguntar']
            self.seccionCondicion=kwargs['seccionCondicion']
            self.seccionCondicionIncompleto=kwargs['seccionCondicionIncompleto']
